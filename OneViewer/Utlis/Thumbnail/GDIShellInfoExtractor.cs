...
namespace OneViewer.Utlis
{
    ...
    public partial class GDIExtractor : IExtractor
    {
        ...
        protected static extern bool GetFileAttributesEx(string lpFileName,
            GET_FILEEX_INFO_LEVELS fInfoLevelId,
            out WIN32_FILE_ATTRIBUTE_DATA fileData);

        protected enum GET_FILEEX_INFO_LEVELS
        {
        ...
        protected struct WIN32_FILE_ATTRIBUTE_DATA
        {
        ...
        protected static extern IntPtr SHGetFileInfo(string pszPath, FileAttributes dwFileAttributes, out SHFILEINFO psfi, uint cbFileInfo, SHGFI uFlags);
        ...
        protected const int MAX_TYPE = 80;
        
        [Flags]
        protected enum SHGFI : uint
        {
            Icon = 0x000000100,
