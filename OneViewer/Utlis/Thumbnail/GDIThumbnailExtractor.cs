...
namespace OneViewer.Utlis
{
    ...
    {
        #region Exif Tag IDs
        protected const int TagThumbnailData = 0x501B;
        protected const int TagOrientation = 0x0112;
        #endregion
        ...
        protected static int GetRotation(Image img)
        {
            try
            {
        ...
        protected static int GetRotation(string filename)
        {
            try
            {
