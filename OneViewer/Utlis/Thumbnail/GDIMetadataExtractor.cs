...
namespace OneViewer.Utlis
{
    ...
    public partial class GDIExtractor : IExtractor
    {
        ...
        #region Exif Tag IDs
        protected const int TagImageDescription = 0x010E;
        protected const int TagEquipmentModel = 0x0110;
        protected const int TagDateTimeOriginal = 0x9003;
        protected const int TagArtist = 0x013B;
        protected const int TagCopyright = 0x8298;
        protected const int TagExposureTime = 0x829A;
        protected const int TagFNumber = 0x829D;
        protected const int TagISOSpeed = 0x8827;
        protected const int TagUserComment = 0x9286;
        protected const int TagRating = 0x4746;
        protected const int TagRatingPercent = 0x4749;
        protected const int TagEquipmentManufacturer = 0x010F;
        protected const int TagFocalLength = 0x920A;
        protected const int TagSoftware = 0x0131;
        #endregion
        ...
        protected static string ExifAscii(byte[] value)
        {
        ...
        /// </summary>
        /// <param name="value">Exif data as a byte array.</param>
        protected static DateTime ExifDateTime(byte[] value)
        {
        ...
        protected static DateTime ExifDateTime(string value)
        {
        ...
        /// </summary>
        /// <param name="value">Exif data as a byte array.</param>
        protected static ushort ExifUShort(byte[] value)
        {
        ...
        /// </summary>
        /// <param name="value">Exif data as a byte array.</param>
        protected static uint ExifUInt(byte[] value)
        {
        ...
        /// </summary>
        /// <param name="value">Exif data as a byte array.</param>
        protected static int ExifInt(byte[] value)
        {
        ...
        /// </summary>
        /// <param name="value">Exif data as a byte array.</param>
        protected static string ExifURational(byte[] value)
        {
        ...
        /// </summary>
        /// <param name="value">Exif data as a byte array.</param>
        protected static string ExifRational(byte[] value)
        {
        ...
        /// </summary>
        /// <param name="value">Exif data as a byte array.</param>
        protected static double ExifDouble(byte[] value)
        {
        ...
        protected static Metadata InitViaBmp(string path)
        {
        ...
        protected static Metadata InitViaBmp(Image img)
        {
        ...
        protected static DateTime ConvertFileTime(System.Runtime.InteropServices.ComTypes.FILETIME ft)
        {
