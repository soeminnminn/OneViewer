...
namespace OneViewer.Controls
{
    ...
    {
        #region Variables
        protected Size childSize = Size.Empty;
        ...
        public static readonly DependencyProperty SpacingModeProperty = DependencyProperty.Register(
            nameof(SpacingMode), typeof(SpacingMode), typeof(VirtualizingWrapPanel), 
            new FrameworkPropertyMetadata(SpacingMode.Uniform, FrameworkPropertyMetadataOptions.AffectsMeasure));

        /// <summary>
        /// NoWrap DependencyProperty
        /// </summary>
        public static readonly DependencyProperty NoWrapProperty = DependencyProperty.Register(
            nameof(NoWrap), typeof(bool), typeof(VirtualizingWrapPanel),
            new FrameworkPropertyMetadata(false, FrameworkPropertyMetadataOptions.AffectsArrange | FrameworkPropertyMetadataOptions.AffectsMeasure,
                (s, e) => ((VirtualizingWrapPanel)s).OnNoWrapChanged((bool)e.OldValue, (bool)e.NewValue)));
        ...
        public static readonly DependencyProperty OrientationProperty = DependencyProperty.RegisterAttached(
            ...
            new FrameworkPropertyMetadata(Orientation.Vertical, 
                ...
                (s, e) => ((VirtualizingWrapPanel)s).OnOrientationChanged((Orientation)e.OldValue, (Orientation)e.NewValue)));

        public static readonly DependencyProperty ItemSizeProperty = DependencyProperty.Register(
            nameof(ItemSize), typeof(Size), typeof(VirtualizingWrapPanel), 
        ...
        public static readonly DependencyProperty StretchItemsProperty = DependencyProperty.Register(
            nameof(StretchItems), typeof(bool), typeof(VirtualizingWrapPanel), 
        ...
        // <summary>
        /// Get/Set the no wrap mode of the panel
        /// </summary>
        public bool NoWrap
        {
            get { return (bool)this.GetValue(NoWrapProperty); }
            set { this.SetValue(NoWrapProperty, value); }
        }
        ...
        #region Methods
        protected virtual void OnNoWrapChanged(bool oldValue, bool newValue)
        {
        ...
        {
            MouseWheelScrollDirection = newValue == Orientation.Vertical ? ScrollDirection.Vertical : ScrollDirection.Horizontal;
        }
        ...
        private void UpdateChildSize(Size availableSize)
        {
            ...
            else if (double.IsInfinity(GetWidth(availableSize)))
            {
        ...
        private Size CalculateChildSize()
        {
            ...
            if (itemsControl == null || !itemsControl.HasItems) return new Size(0, 0);
        ...
        protected override Range UpdateItemRange()
        {
            if (!IsVirtualizing)
            {
                return new Range(0, Items.Count - 1);
            }
